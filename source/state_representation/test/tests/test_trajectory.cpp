...
//   state_representation::Trajectory<state_representation::JointState>
//   trajectory; state_representation::JointState point("robot", 1);

//   std::deque<state_representation::JointState> points =
//   trajectory.get_points(); std::deque<std::chrono::nanoseconds> times =
//   trajectory.get_times();
...
//   std::pair<state_representation::JointState, std::chrono::nanoseconds>
//   point0 = trajectory[0]; std::pair<state_representation::JointState,
//   std::chrono::nanoseconds> point1 = trajectory[1];
...
// 	std::pair<state_representation::JointState, std::chrono::nanoseconds>
// last_point = trajectory[1]; 	std::deque<state_representation::JointState>
// points = trajectory.get_points(); 	std::deque<std::chrono::nanoseconds>
// times = trajectory.get_times();
...
// 	std::pair<state_representation::JointState, std::chrono::nanoseconds>
// inserted_point = trajectory[1]; 	last_point = trajectory[2]; 	points =
// trajectory.get_points(); 	times = trajectory.get_times();
