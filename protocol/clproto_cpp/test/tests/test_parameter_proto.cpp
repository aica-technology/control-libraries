...
template<typename T>
using ParamT = std::tuple<T, clproto::ParameterMessageType>;

static std::tuple<
    ParamT<bool>, ParamT<std::vector<bool>>, ParamT<int>, ParamT<std::vector<int>>, ParamT<double>,
    ParamT<std::vector<double>>, ParamT<std::string>, ParamT<std::vector<std::string>>, ParamT<Eigen::VectorXd>,
    ...
    parameter_test_cases{
        ...
        std::make_tuple(1.0, clproto::ParameterMessageType::DOUBLE),
        std::make_tuple(std::vector<double>({1.0, 2.0, 3.0}), clproto::ParameterMessageType::DOUBLE_ARRAY),
        std::make_tuple("test", clproto::ParameterMessageType::STRING),
        std::make_tuple(std::vector<std::string>({"1", "2", "3"}), clproto::ParameterMessageType::STRING_ARRAY),
